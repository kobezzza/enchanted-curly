...
module.exports = {
	meta: {
		...
		messages: {
			...
			requireLineBreakBefore: "A line break is required before '{{token}}'.",
			requireLineBreakAfter: "A line break is required after '{{token}}'.",
			unexpectedLineBreakBefore: "There should be no line break before '{{token}}'.",
			unexpectedLineBreakAfter: "There should be no line break after '{{token}}'.",
		}
	},
	...
	create(context) {
		 ...
		 *
		 * @param {string} option - option to exclude
		 * @returns {boolean}
		 */
		...
		/**
		 * Determines whether an option is toggled to "spaced", relative to the global spacing option
		 *
		 * @param {string} option - option to exclude
		 * @returns {boolean}
		 */
		 ...
		 *
		 * @param {ASTNode} node - node to report in the event of an error
		 * @param {Token} token - token to use for the report
		 * @returns {void}
		 */
		...
		/**
		 * Reports that there shouldn't be a line break before the last token
		 *
		 * @param {ASTNode} node - node to report in the event of an error
		 * @param {Token} token - token to use for the report
		 * @returns {void}
		...
		/**
		 * Reports that there should be a line break before the last token
		 *
		 * @param {ASTNode} node - node to report in the event of an error
		 * @param {Token} token - token to use for the report
		 * @returns {void}
		 ...
		 * @param {Token} first - first token to check (should be the opening brace)
		 * @param {Token} second - second token to check (should be first after the opening brace)
		 * @param {Token} penultimate - penultimate token to check (should be last before closing brace)
		 * @param {Token} last - last token to check (should be closing brace)
		 * @returns {void}
		 */
		 ...
		 * first '}' token.
		 *
		 * @param {ASTNode} node - node to get. This node is an ObjectExpression or an ObjectPattern.
		 *   And this node has one or more properties.
		 *
		 * @returns {Token}
		 */
		 ...
		 *
		 * @param {ASTNode} node - ObjectExpression or ObjectPattern node to check
		 * @returns {void}
		 */
		 ...
		 *
		 * @param {ASTNode} node - ImportDeclaration node to check
		 * @returns {void}
		 */
		 ...
		 *
		 * @param {ASTNode} node - ExportNamedDeclaration node to check
		 * @returns {void}
		 */
